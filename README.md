...
In source folder 2 subfolders are present:Java and Test.
All java files are tested with testcases.
All testcases are written in test.java classes in test folder.
